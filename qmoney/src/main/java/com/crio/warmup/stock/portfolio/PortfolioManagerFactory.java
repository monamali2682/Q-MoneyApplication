  ...
  //       ./gradlew test --tests PortfolioManagerFactory
   ...
   public static PortfolioManager getPortfolioManager(String provider,
     RestTemplate restTemplate) {
      StockQuotesService stockservice = StockQuoteServiceFactory.getService(provider, restTemplate);
      PortfolioManager portfoliomanager = new PortfolioManagerImpl(stockservice);
      return portfoliomanager;
   }
